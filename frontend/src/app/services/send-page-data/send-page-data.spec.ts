...
describe('SendPageDataService', () => {
  ...
  it(
    'should be created',
    inject([SendPageDataService], (service: SendPageDataService) => {
      expect(service).toBeTruthy()
    })
  )

  it(
    "should be able to clear it's data",
    inject([SendPageDataService], (service: SendPageDataService) => {
  ...
  it(
    "shouldn't broadcast data after clearing if told not to",
    inject([SendPageDataService], (service: SendPageDataService) => {
      this.blankBundle = service.dataBundle
      service.dataBundle = this.testDataBundle //fill with data
      spyOn(service.dataSubject, 'next').and.stub()
  ...
  it(
    'should pass data into the dataSubject',
    inject([SendPageDataService], (service: SendPageDataService) => {
      spyOn(service.dataSubject, 'next').and.stub()
  ...
  it(
    'should return dataSubject as an Observable',
    inject([SendPageDataService], (service: SendPageDataService) => {
  ...
  it(
    'should return getDataStatusStream as an Observable',
    inject([SendPageDataService], (service: SendPageDataService) => {
  ...
  it(
    'should validate the transferAmount in a the formData is a number',
    inject([SendPageDataService], (service: SendPageDataService) => {
  ...
  it(
    'should validate if the the formData has a NAV to NAV transfer',
    inject([SendPageDataService], (service: SendPageDataService) => {
      spyOn(service, 'getMinTransferAmount').and.returnValue(0)
  ...
  it(
    'should validate the transferAmount in the formData is big enough',
    inject([SendPageDataService], (service: SendPageDataService) => {
  ...
  it(
    "should validate if a databundle's transferAmount is too large",
    inject([SendPageDataService], (service: SendPageDataService) => {
  ...
  it(
    "should validate if a databundle's address is valid",
    inject([SendPageDataService], (service: SendPageDataService) => {
      spyOn(service, 'pushError').and.stub()
      spyOn(service, 'checkAddressIsValid').and.callFake(str => {
  ...
  it(
    'should be able to push errors onto a databundle',
    inject([SendPageDataService], (service: SendPageDataService) => {
  ...
  it(
    'should be able to check if an address is valid',
    inject([SendPageDataService], (service: SendPageDataService) => {
      // address is invalid
      let addr = undefined
  ...
  it(
    'should return if errors are found in the submitted form data',
    inject([SendPageDataService], (service: SendPageDataService) => {
      ...
      service.storeData(
        dataBundleAfterStorage.transferAmount,
        dataBundleAfterStorage.originCoin,
        dataBundleAfterStorage.destCoin,
        dataBundleAfterStorage.destAddr
      )
  ...
  it(
    ...
    inject([SendPageDataService], (service: SendPageDataService) => {
      ...
      expect(service.clearData).toHaveBeenCalled()
      expect(service.validateFormData).toHaveBeenCalledWith(dataBundleAfterStorage)
      expect(service.estimateFirstExchange).toHaveBeenCalledWith(
        dataBundleAfterStorage.originCoin,
        dataBundleAfterStorage.destCoin,
        dataBundleAfterStorage.transferAmount
      )
  ...
  it(
    'should be able to get an estimated exchange amount',
    async(
      inject([SendPageDataService], (service: SendPageDataService) => {
  ...
  it(
    'should be able to get the minimum transfer amount',
    async(
      inject([SendPageDataService], (service: SendPageDataService) => {
