...
describe('SendCoinsFormComponent', () => {
  ...
  beforeEach(
    async(() => {
      TestBed.configureTestingModule({
        ...
        imports: [FormsModule, HttpClientModule, MaterializeModule, RouterTestingModule],
        providers: [
  ...
  it(
    'should get the currency data',
    async(
      inject([SendCoinsFormComponent], (sendCoinsSection: SendCoinsFormComponent) => {
  ...
  it(
    'should invalidate estimate data',
    inject([SendCoinsFormComponent], (sendCoinsSection: SendCoinsFormComponent) => {
  ...
  it(
    'toggle form state after a certain time',
    async(
      inject([SendCoinsFormComponent], (sendCoinsSection: SendCoinsFormComponent) => {
